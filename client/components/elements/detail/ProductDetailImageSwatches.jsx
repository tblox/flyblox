          ...
          <div className='ps-product__info'>
            ...
            <div className='ps-product__variations'>
                ...
                {product.variants.map(variant => {
                  return (
                    <div
                      ...
                      key={variant.id}
                      onClick={e => this.handleSwitchVariant(variant.id)}
                    >
              ...
              <figure>
                ...
                <div className='ps-variant ps-variant--size'>
                  <span className='ps-variant__tooltip'>S</span>
                  <span className='ps-variant__size'>S</span>
                </div>
                <div className='ps-variant ps-variant--size'>
                  <span className='ps-variant__tooltip'> M</span>
                  <span className='ps-variant__size'>M</span>
                </div>
                <div className='ps-variant ps-variant--size'>
                  <span className='ps-variant__tooltip'> L</span>
            ...
            <div className='ps-product__specification'>
              ...
              <p className='categories'>
                ...
                <a href='#'> Refrigerator</a>,<a href='#'>Babies & Moms</a>
              </p>
              <p className='tags'>
                <strong> Tags</strong>
